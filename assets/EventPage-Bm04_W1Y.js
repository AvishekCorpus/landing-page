import{r as m,j as e,P as g}from"./index-BDjiWG2k.js";import{C as v,G as h,a as j}from"./index-DM3eU9cG.js";import{C as f}from"./index-HLqh1Lzz.js";import"./ResizeObserver.es-B1PUzC5B.js";import"./useVariants-BHOOrviR.js";const E=()=>{var n,a,c,l;const[s,d]=m.useState(),p=({onClick:t})=>e.jsx("div",{className:"custom-arrow custom-prev",onClick:t,children:e.jsx(j,{})}),u=({onClick:t})=>e.jsx("div",{className:"custom-arrow custom-next",onClick:t,children:e.jsx(h,{})}),x=async()=>{const o=`https://tr3yh6z2.api.sanity.io/v1/data/query/production?query=${encodeURIComponent(`*[_type == "event"][0] {
      title,
      image {
        asset -> {
          url
