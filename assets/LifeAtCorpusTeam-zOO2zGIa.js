import{r as a,j as s,P as z}from"./index-DbDPHvz6.js";import{C as W,G as q,a as P}from"./index-B-rYKpCP.js";import"./ResizeObserver.es-B1PUzC5B.js";const b=()=>{const[o,v]=a.useState(),[r,S]=a.useState({image:"",description:""}),[y,I]=a.useState(""),[T,i]=a.useState(4),[E,n]=a.useState(300),m=()=>{const e=window.innerWidth;e<=480?i(1):e<=768?i(2):e<=1024?i(3):i(4)},d=()=>{const e=window.innerWidth;e>=1200||e>=768,n(240)};a.useEffect(()=>(L(),m(),d(),window.addEventListener("resize",m),window.addEventListener("resize",d),()=>{window.removeEventListener("resize",m),window.removeEventListener("resize",d)}),[]);const U=({onClick:e})=>s.jsx("div",{className:"custom-arrow custom-prev",onClick:e,children:s.jsx(P,{})}),A=({onClick:e})=>s.jsx("div",{className:"custom-arrow custom-next",onClick:e,children:s.jsx(q,{})}),L=async()=>{var u,l,p,g,w,h,x,f,C,j;const c=`https://tr3yh6z2.api.sanity.io/v1/data/query/production?query=${encodeURIComponent(`*[_type == "lifeAtCorpus"][0] {
      teamCorpus {
        mainImage {
          "imageUrl": asset->url,
        },
