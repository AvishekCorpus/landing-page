import{r as m,j as e,P as g}from"./index-DfNNJleS.js";import{C as v,G as h,a as j}from"./index-CQrgcIJR.js";import{C as f}from"./index-utLsOLZ_.js";import"./ResizeObserver.es-B1PUzC5B.js";import"./useVariants-rWG0T-Vj.js";const E=()=>{var n,a,c,l;const[s,d]=m.useState(),p=({onClick:t})=>e.jsx("div",{className:"custom-arrow custom-prev",onClick:t,children:e.jsx(j,{})}),u=({onClick:t})=>e.jsx("div",{className:"custom-arrow custom-next",onClick:t,children:e.jsx(h,{})}),x=async()=>{const o=`https://tr3yh6z2.api.sanity.io/v1/data/query/production?query=${encodeURIComponent(`*[_type == "event"][0] {
      title,
      image {
        asset -> {
          url
